...
class SdgIndicatorController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('admin.indicators.index')->with('success', 'Индикатор создан');
    }
    ...
    public function update(Request $request, SdgIndicator $indicator)
    {
        ...
        return redirect()->route('admin.indicators.index')->with('success', 'Индикатор обновлён');
    }

    public function destroy(SdgIndicator $indicator)
    {
        $indicator->delete();
        return redirect()->route('admin.indicators.index')->with('success', 'Индикатор удалён');
    }
}
